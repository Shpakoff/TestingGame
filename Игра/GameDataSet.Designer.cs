...
namespace Игра {
    ...
    public partial class GameDataSet : global::System.Data.DataSet {
        ...
        public partial class ПользователиDataTable : global::System.Data.TypedTableBase<ПользователиRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public ПользователиRow AddПользователиRow(string Имя, string Логин, string Пароль) {
...
namespace Игра.GameDataSetTableAdapters {
    ...
    public partial class ПользователиTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Пользователи` WHERE ((`Код` = ?) AND ((? = 1 AND `Имя` IS NULL) OR (" +
                "`Имя` = ?)) AND ((? = 1 AND `Логин` IS NULL) OR (`Логин` = ?)) AND ((? = 1 AND `" +
                "Пароль` IS NULL) OR (`Пароль` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Пользователи` (`Имя`, `Логин`, `Пароль`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Пользователи` SET `Имя` = ?, `Логин` = ?, `Пароль` = ? WHERE ((`Код` = ?)" +
                " AND ((? = 1 AND `Имя` IS NULL) OR (`Имя` = ?)) AND ((? = 1 AND `Логин` IS NULL)" +
                " OR (`Логин` = ?)) AND ((? = 1 AND `Пароль` IS NULL) OR (`Пароль` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Игра.Properties.Settings.Default.GameConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Код, Имя, Логин, Пароль FROM Пользователи";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT Код, Имя, Логин, Пароль FROM Пользователи WHERE [Логин] = ? AND [Пароль] =" +
                " ?";
        ...
        public virtual int Fill(GameDataSet.ПользователиDataTable dataTable) {
        ...
        public virtual GameDataSet.ПользователиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            GameDataSet.ПользователиDataTable dataTable = new GameDataSet.ПользователиDataTable();
        ...
        public virtual GameDataSet.ПользователиDataTable GetDataBy(string Логин, string Пароль) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(GameDataSet.ПользователиDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Код, string Original_Имя, string Original_Логин, string Original_Пароль) {
        ...
        public virtual int Insert(string Имя, string Логин, string Пароль) {
            if ((Имя == null)) {
        ...
        public virtual int Update(string Имя, string Логин, string Пароль, int Original_Код, string Original_Имя, string Original_Логин, string Original_Пароль) {
            if ((Имя == null)) {
